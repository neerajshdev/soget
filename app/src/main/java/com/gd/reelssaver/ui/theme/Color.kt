...
val md_theme_dark_primary = Color(0xFFFF5449) // Brighter red for dark theme
val md_theme_dark_onPrimary = Color(0xFF690000)
val md_theme_dark_primaryContainer = Color(0xFFB3000B) // Deep red container
val md_theme_dark_onPrimaryContainer = Color(0xFFFFDAD9)
val md_theme_dark_secondary = Color(0xFFFF8A80) // Lighter red for dark theme
...
val md_theme_dark_tertiaryContainer = Color(0xFF802800)
